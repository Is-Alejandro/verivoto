    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route element={<Layout />}>
          ...
          {/* CandidatesSection */}
          <Route path="/candidatos/presidenciales" element={<ProtectedRoute><PlaceholderPage title="Candidatos Presidenciales" /></ProtectedRoute>} />
          <Route path="/candidatos/senadores" element={<ProtectedRoute><PlaceholderPage title="Senadores" /></ProtectedRoute>} />
          <Route path="/candidatos/diputados" element={<ProtectedRoute><PlaceholderPage title="Diputados" /></ProtectedRoute>} />
          <Route path="/candidatos/parlamento-andino" element={<ProtectedRoute><PlaceholderPage title="Parlamento Andino" /></ProtectedRoute>} />
